...
";
		...
		/// <summary>
		/// Removes characters from the player's character list.
		/// </summary>
		/// <param name="player">The id of the player.</param>
		/// <param name="characters">The characters to remove.</param>
		public void RemoveCharacters(int playerId, ReadOnlyCollection<Character> characters)
		{
			const string sql = @"
