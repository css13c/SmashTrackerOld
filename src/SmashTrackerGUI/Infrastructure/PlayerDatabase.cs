...
";
		...
		/// <returns></returns>
		public ObservableCollection<Player> GetPR(int size)
		{
			const string sql = @"
SELECT * FROM players p
INNER JOIN player_characters pc ON p.Id = pc.PlayerId
...
";
		...
		/// <returns></returns>
		public ObservableCollection<Player> GetPlayersOfCharacter(Character character)
		{
			const string sql = @"
SELECT * FROM players p
INNER JOIN player_characters pc ON p.Id = pc.PlayerId
...
";
		...
		/// <returns></returns>
		public ObservableCollection<Player> GetPlayersByName(string query)
		{
			const string sql = @"
SELECT * FROM players p
INNER JOIN player_characters pc ON p.Id = pc.PlayerId
...
";
		...
		/// <param name="query">The search query</param>
		/// <returns></returns>
		public ObservableCollection<Player> GetPlayersByNameOrTag(string query)
		{
			const string sql = @"
SELECT * FROM players p
INNER JOIN player_characters pc ON p.Id = pc.PlayerId
...
";
			...
			return new Player(playerId, addName, addTag, addRating, new ObservableCollection<Character> { addChar });
		}
